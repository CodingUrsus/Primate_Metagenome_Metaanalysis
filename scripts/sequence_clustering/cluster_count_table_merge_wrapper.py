...
def build_normalized_KO_table(count_tab, gene_mapping_fi, out_loc):
	KO_table_command = str("python ~/scripts/create_mcl_cluster_count_table.py --count_table " + count_tab + " --gene_cluster_mapping_file " + gene_mapping_fi + " --out_location " + out_loc)
...
for some_count_table in count_table_list:
	...
	build_normalized_KO_table(some_count_table, gene_cluster_mapping_file, out_location)
